  ...
  return (
    <>
      <div style={{width:"100vw"}}>
        ...
        <div className="page1 gradient1">
          ...
          <div className=" page1mainheadingContainer" style={{backgroundColor:"transparent", color:"#ffffff", display:"flex", justifyContent:"center", alignItems:"center", textAlign:"center"}}>
              <h1 className="page1mainheading">The Ultimate Social Media Growth Engine for Fast-Growing Startups</h1>
          </div>
          ...
          <div style={{marginTop:"0px", paddingBottom:"70px"}}>
            <Marquee pauseOnHover={false} play={true}>
              <Corousel source="visibleCampus.jpeg" heading="Marketing Stories" subHeading="825K Followers"/>
              <Corousel source="visibleCampus.jpeg" heading="Startupnews FYI" subHeading="390K Followers"/>
              <Corousel source="visibleCampus.jpeg" heading="Creators of Metaverse" subHeading="10K Followers"/>
              <Corousel source="blackSwan.jpeg" heading="Blackswan Business Setup" subHeading="15K Followers"/>
              <Corousel source="scoolya.jpeg" heading="Bioscoolya" subHeading="100K Followers"/>
              <Corousel source="visibleCampus.jpeg" heading="Atomscoolya" subHeading="90K Followers"/>
              <Corousel source="factsAndStuffByD.jpeg" heading="Facts and Stuff by D" subHeading="10K Followers"/>
              <Corousel source="visibleCampus.jpeg" heading="Truely Sarcastic" subHeading="50K Followers"/>
              <Corousel source="visibleCampus.jpeg" heading="Startupnews FYI" subHeading="We increased 60k in 5 months"/>
            </Marquee>
          </div>
      ...
      <div className="page2" ref={ref} style={{backgroundColor:"transparent"}}>
        ...
        <div>
          {/*Content being display on 1st button click*/}
          {
        ...
        <div>
          {/*Content being display on 2nd button click*/}
          {
        ...
        <div>
          {/*Content being display on 3rd button click*/}
          {
        ...
        <div>
          {/*Content being display on 4th button click*/}
          {
        ...
        <div className="container" style={{display:"flex", justifyContent:"center", alignItems:"center"}}>
          ...
          <div className="container" style={{display:"flex", justifyContent:"center", alignItems:"center", textAlign:"center"}}>
            <div className="container page3HeadingContainer" style={{backgroundColor:"transparent", color:"#ffffff", display:"block"}}>
              <p><h1 className="page3Heading">HyperContent Understands The Importance Of Branding & Digital Marketing in this new age economy</h1></p>
            </div>
          </div>
      ...
      {/*For screen sizes above 991 px*/}
      <div className="page4" style={{backgroundColor:"transparent"}}>
        <div className="page4Container">
          <div className="page4Container1Div" style={{backgroundColor:"transparent"}}>
          ...
          <div className="page4Container2Div" style={{backgroundColor:"transparent"}}>

            <div className="col-3 page4Container2ImgContainerDiv">
              <div className="page4Container2ImgContainer" style={{backgroundColor:"transparent"}}>
                <img src="futurenselife1.jpg" className="page4Container2Img" alt="futurenselife1"/>
              </div>
            </div>
            ...
            <div className="col-3">
              <div className="page4Container2ImgContainer" style={{backgroundColor:"transparent"}}>
                <img src="futurenselife3.jpg" className="page4Container2Img" alt="futurenselife3"/>
              </div>
            </div>

            <div className="col-3">
              <div className="page4Container2ImgContainer" style={{backgroundColor:"transparent"}}>
                <img src="futurenselife4.jpg" className="page4Container2Img" alt="futurenselife4"/>
              </div>
            </div>
