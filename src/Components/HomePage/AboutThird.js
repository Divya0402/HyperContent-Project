...
function AboutThird(props) {
  return (
  <>
  <div style={{display:"flex", justifyContent:"center", alignItems:"center"}}>
    <div className="gradient4 aboutcontainer" style={{backgroundColor:`${props.colour}`, display:"flex", justifyContent:"center", alignItems:"center"}}>



      {/*For screen sizes below 992px and between 1120px to 1600px*/}
      ...
      {/*For screen sizes between 992px to 1119px*/}
